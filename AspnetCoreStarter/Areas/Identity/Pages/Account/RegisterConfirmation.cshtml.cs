...
namespace AspnetCoreStarter.Areas.Identity.Pages.Account
{
    ...
    public class RegisterConfirmationModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync(string email, string orgName, string returnUrl = null)
        {
            if (email == null)
            {
            ...
            if (DisplayConfirmAccountLink)
            {
                ...
                EmailConfirmationUrl = Url.Page(
                    ...
                    pageHandler: null,
                    values: new { area = "Identity", userId = userId, code = code, returnUrl = returnUrl, orgName = orgName },
